    ...
    <>
      ...
      <main style={{ backgroundColor: "#FDFAF6", padding: "80px 28px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 52 }} className="grid-2">
            ...
            {/* 情報 */}
            <div>
              <div style={{ fontSize: 22, fontWeight: 700, color: "#2D2D2D", marginBottom: 4 }}>ひだまり整骨院 正雀院</div>
              <div style={{ fontSize: 14, color: "#888", marginBottom: 28 }}>大阪府摂津市正雀本町１丁目20-30</div>

              <div style={{ borderTop: "1px solid #EDE0CC", marginBottom: 28 }}>
                {[
              ...
              <div style={{ backgroundColor: "#EAF7F1", border: "1px solid #A8E0C4", borderRadius: 10, padding: "20px 24px", marginBottom: 22 }}>
                ...
                {[
                  ...
                  <div key={day} style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #A8E0C4", padding: "11px 0" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                <a href="tel:0663193339"
                  style={{ display: "block", backgroundColor: "#D96B0B", color: "#fff", textAlign: "center", padding: "16px", textDecoration: "none", fontSize: 20, fontWeight: 700, letterSpacing: "0.04em", borderRadius: 6 }}>
                  06-6319-3339
                </a>
