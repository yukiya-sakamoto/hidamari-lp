    ...
    <>
      ...
      <main style={{ backgroundColor: "#fff", padding: "80px 28px" }}>
        <div style={{ maxWidth: 1280, margin: "0 auto" }}>
          <p style={{ fontSize: 14, color: "#555555", lineHeight: 2.0, marginBottom: 56, maxWidth: 680 }}>
            健康保険・各種保険・交通事故・労災保険に対応しています。窓口でいただく金額には一部実費診療代が含まれる場合がございます。
          </p>

          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 1, backgroundColor: "#FDDCB5", maxWidth: 900, marginBottom: 48 }} className="grid-2">
            {/* 保険内料金 */}
            ...
            <div style={{ backgroundColor: "#fff" }}>
              ...
              <div style={{ padding: "28px" }}>
                {EXTRA.map(([label, price]) => (
                  <div key={label} style={{ display: "flex", justifyContent: "space-between", borderBottom: "1px solid #FFF0DC", padding: "14px 0" }}>
          ...
          <div style={{ backgroundColor: "#E6F9EE", border: "1px solid #FDDCB5", padding: "28px 32px", maxWidth: 900 }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 16 }}>
              {[
                ...
                <div key={title}>
                  <div style={{ fontSize: 12, fontWeight: 800, color: "#1A1A1A", marginBottom: 6 }}>{title}</div>
                  <div style={{ fontSize: 12, color: "#555555", lineHeight: 1.7 }}>{desc}</div>
                </div>
              ))}
            </div>
          </div>
